 USA
| Platform Name | URL | Managed Services | Region | Twitter/X | Program Types | Has Leaderboard | Leaderboard URL | Public Programs URL |
|---------------|-----|------------------|--------|-----------|---------------|-----------------|-----------------|---------------------|
...
| Cantina | [https://cantina.xyz](https://cantina.xyz) | Yes | USA | [@Cantinaxyz](https://x.com/Cantinaxyz) | Private + Public | Yes | | [https://cantina.xyz/competitions](https://cantina.xyz/competitions) |
| CertiK Bug Bounty | [https://certik.com](https://certik.com) | Yes | USA | [@CertiK](https://x.com/CertiK) | Private + Public | Yes | [https://skynet.certik.com/leaderboards/bug-bounty](https://skynet.certik.com/leaderboards/bug-bounty) | [https://skynet.certik.com/leaderboards/bug-bounty](https://skynet.certik.com/leaderboards/bug-bounty) |
| CISA VDP Platform | [https://cisa.gov/vdp](https://cisa.gov/vdp) | Yes | USA | [@CISAgov](https://x.com/CISAgov) | Public | No | | |
...
| CodeHawks | [https://codehawks.cyfrin.io](https://codehawks.cyfrin.io) | Yes | USA | [@CodeHawks](https://x.com/CodeHawks) | Private + Public | Yes | [https://codehawks.cyfrin.io/leaderboard](https://codehawks.cyfrin.io/leaderboard) | [https://codehawks.cyfrin.io](https://codehawks.cyfrin.io) |
...
| Topcoder | [https://topcoder.com](https://topcoder.com) | Yes | USA | [@topcoder](https://x.com/topcoder) | Private + Public | Yes | [https://www.topcoder.com/community/member-statistics](https://www.topcoder.com/community/member-statistics) | [https://www.topcoder.com/challenges](https://www.topcoder.com/challenges) |
...
Here are the remaining bug bounty platforms from countries other than the USA, grouped by region:
...
| Platform Name | URL | Managed Services | Region | Twitter/X | Program Types | Has Leaderboard | Leaderboard URL | Public Programs URL |
|---------------|-----|------------------|--------|-----------|---------------|-----------------|-----------------|---------------------|
| AuditOne | [https://auditone.io](https://auditone.io) | Yes | Europe | [@AuditOne_io](https://x.com/AuditOne_io) | Private + Public | Yes | [https://www.auditone.io/bounty-activity](https://www.auditone.io/bounty-activity) | [https://www.auditone.io/bug-bounty](https://www.auditone.io/bug-bounty) |
...
| Crowdcurity | [https://crowdcurity.com](https://crowdcurity.com) | Yes | Denmark | [@crowdcurity](https://x.com/crowdcurity) | Private + Public | Yes | | [https://crowdcurity.com/programs](https://crowdcurity.com/programs) |
...
| Butian | [https://butian.net](https://butian.net) | Yes | China | | Private + Public | Yes | | |
...
| Cyber3ra | [https://cyber3ra.com](https://cyber3ra.com) | Yes | India | | Private + Public | Yes | | [https://app.cyber3ra.com](https://app.cyber3ra.com) |
| Detectify | [https://detectify.com](https://detectify.com) | Yes | Sweden | [@detectify](https://x.com/detectify) | Private | Yes | | |
| IssueHunt | [https://issuehunt.io](https://issuehunt.io) | Yes | Japan | [@IssueHunt](https://x.com/IssueHunt) | Private + Public | Yes | | [https://issuehunt.io/programs](https://issuehunt.io/programs) |
...
| PatchDay | [https://patchday.io](https://patchday.io) | Yes | South Korea | [@patchday_io](https://x.com/patchday_io) | Private + Public | Yes | | [https://patchday.io](https://patchday.io) |
...
| safehats | [https://safehats.com](https://safehats.com/) | Yes | India | | Private + Public | Yes | [https://app.safehats.com/member/leaderboard](https://app.safehats.com/member/leaderboard) | |
...
| Platform Name | URL | Managed Services | Region | Twitter/X | Program Types | Has Leaderboard | Leaderboard URL | Public Programs URL |
|---------------|-----|------------------|--------|-----------|---------------|-----------------|-----------------|---------------------|
| Bug Bounty Box | [https://bugbountybox.com](https://bugbountybox.com) | Yes | Kenya/Africa | | | | | |
| BUGLOUD | [https://bugloud.com](https://bugloud.com) | Yes | United Arab Emirates | | Private + Public | | | |
...
| Hacckers | [https://hacckers.com](https://hacckers.com) | Yes | Israel | | Private + Public | | | |
...
| UAE National Bug Bounty | [https://bugbounty.ae](https://bugbounty.ae) | Yes | United Arab Emirates | | Private + Public | | | [https://bugbounty.ae](https://bugbounty.ae) |
...
| Hashlock | [https://hashlock.com](https://hashlock.com) | Yes | Australia | [@HashLockAudit](https://x.com/HashLockAudit) | Private + Public | No | | [https://hashlock.com/bug-bounty](https://hashlock.com/bug-bounty) |
...
| Platform Name | URL | Managed Services | Region | Twitter/X | Program Types | Has Leaderboard | Leaderboard URL | Public Programs URL |
|---------------|-----|------------------|--------|-----------|---------------|-----------------|-----------------|---------------------|
| Bug Bounty Argentina | [https://bugbountyargentina.org](https://bugbountyargentina.org) | | Argentina | | | | | |
...
| Gerobug | [https://gerobug.gerosecurity.com](https://gerobug.gerosecurity.com) | No | Indonesia | | Self-hosted | No | | |
...
| Platform Name | URL | Managed Services | Region | Twitter/X | Program Types | Has Leaderboard | Leaderboard URL | Public Programs URL |
|---------------|-----|------------------|--------|-----------|---------------|-----------------|-----------------|---------------------|
| BI.ZONE Bug Bounty | [https://bugbounty.bi.zone](https://bugbounty.bi.zone) | Yes | Russia | [@bizone](https://x.com/bizone) | Private + Public | Yes | | |
| Standoff 365 Bug Bounty | [https://bugbounty.standoff365.com](https://bugbounty.standoff365.com) | Yes | Russia | [@standoff365](https://x.com/standoff365) | Private + Public | Yes | [https://bugbounty.standoff365.com/en-US/rating/](https://bugbounty.standoff365.com/en-US/rating/) | [https://bugbounty.standoff365.com/en-US/](https://bugbounty.standoff365.com/en-US/) |

---

### **Global / Unspecified Region**
| Platform Name | URL | Managed Services | Region | Twitter/X | Program Types | Has Leaderboard | Leaderboard URL | Public Programs URL |
|---------------|-----|------------------|--------|-----------|---------------|-----------------|-----------------|---------------------|
...
| OWASP BLT | [https://bugheist.com](https://bugheist.com) | No | Global | [@oikitoikia](https://x.com/oikitoikia) | Public | Yes | | |
| Patchstack | [https://patchstack.com](https://patchstack.com) | Yes | Estonia | [@paborza](https://x.com/paborza) | Public | Yes | [https://patchstack.com/database/leaderboard](https://patchstack.com/database/leaderboard) | [https://patchstack.com/database/vdp](https://patchstack.com/database/vdp) |
| Remedy | [https://r.xyz](https://r.xyz) | Yes | Global | [@xyz_remedy](https://x.com/xyz_remedy) | Private + Public | No | | [https://hunt.r.xyz](https://hunt.r.xyz) |
